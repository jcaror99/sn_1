<%@ Page Language='VB' MasterPageFile='~/master/master/mas_grillaFormularioHorizontal.master'
    AutoEventWireup='false' CodeBehind='gen_zona.aspx.vb' Inherits='website.samm_web.frm_gen_zona' %>

<%@ Register Src="~/controles/gen/inc_zona.ascx" TagName="inc_zona" TagPrefix="uc1" %>
...
<asp:Content ID='Content2' ContentPlaceHolderID='cph_grilla' runat='Server'>
   <uc1:inc_zona ID="Inc_zona1" runat="server" />
</asp:Content>
...
<asp:Content ID='content5' runat='server' ContentPlaceHolderID='cph_tituloPagina'><asp:Label ID='lbl_tituloPagina' runat='server' CssClass='lbl_titulo' Text="<%$ Resources:res_tituloPagina, forms_gen_zona%>"></asp:Label></asp:Content>
