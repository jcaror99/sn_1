...
<%@ Page Language='VB' MasterPageFile='~/master/master/mas_grillaFormularioHorizontal.master' AutoEventWireup='false' CodeBehind='cat_catalogo_producto.aspx.vb' Inherits='website.samm_web.frm_cat_catalogo_producto'%>
...
<asp:Content ID='content5' runat='server'  ContentPlaceHolderID='cph_tituloPagina'><asp:Label ID='lbl_tituloPagina' runat='server' CssClass='lbl_titulo' Text="<%$ Resources:res_tituloPagina, forms_cat_catalogo_producto%>"></asp:Label></asp:Content>
