...
AutoEventWireup="false" CodeBehind="firmarReportes.aspx.vb" Inherits="website.samm_web.forms_doc_firmarReportes" %>
...
<%@ Register src="~/controles/doc/buscarReportes.ascx" tagname="buscarReportes" tagprefix="uc5" %>
<%@ Register src="~/controles/doc/firmarReportes.ascx" tagname="busFirmarReportes" tagprefix="uc6" %>
...
<uc5:buscarReportes ID="buscarReportes" runat="server" />
</td>
</tr>
</table>
</asp:View>
...
<tr>
<td class="tbl_marcoFormulario">
<uc6:busFirmarReportes ID="busFirmarReportes" runat="server" />
</td>
</tr>
</table>
</asp:View>
