<%@ Page Language='VB' MasterPageFile='~/master/master/mas_grillaFormularioHorizontal.master' AutoEventWireup='false' CodeBehind='doc_documento_gasto.aspx.vb' Inherits='website.samm_web.frm_doc_doc_documento_gasto'%>
...
<asp:LinkButton ID="lnk_nuevoDoc" runat="server" CssClass='invisible' CausesValidation="false"></asp:LinkButton><tab:tabs ID='Tabs' OnTab='s_mostrarTab' runat='server' />
</asp:Content>
...
<asp:Content ID='content5' runat='server'  ContentPlaceHolderID='cph_tituloPagina'><asp:Label ID='lbl_tituloPagina' runat='server' CssClass='lbl_titulo' Text="<%$ Resources:res_tituloPagina, forms_doc_documento_gasto%>"></asp:Label></asp:Content>
