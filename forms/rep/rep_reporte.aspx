...
<%@ Page Language='VB' MasterPageFile='~/master/master/mas_grillaFormularioHorizontal.master' ValidateRequest="false" EnableEventValidation="false" AutoEventWireup='false' CodeBehind='rep_reporte.aspx.vb' Inherits='website.samm_web.frm_rep_reporte'%>
...
<asp:Content ID='content5' runat='server'  ContentPlaceHolderID='cph_tituloPagina'><asp:Label ID='lbl_tituloPagina' runat='server' CssClass='lbl_titulo' Text="<%$ Resources:res_tituloPagina, forms_rep_reporte%>"></asp:Label></asp:Content>
