...
<%@ Page Language='VB' MasterPageFile='~/master/master/mas_grillaFormularioHorizontal.master' AutoEventWireup='false' CodeBehind='ter_cargoContacto.aspx.vb' Inherits='website.samm_web.frm_ter_cargoContacto'%>
...
<asp:Content ID='content5' runat='server'  ContentPlaceHolderID='cph_tituloPagina'><asp:Label ID='lbl_tituloPagina' runat='server' CssClass='lbl_titulo' Text="forms_ter_cargoContacto"></asp:Label></asp:Content>
