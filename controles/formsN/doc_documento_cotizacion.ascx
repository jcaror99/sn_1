...
Inherits="website.samm_componentes.controles_seg_doc_documento_cotizacion_N" %>
...
<%@ Register Src="../equ/equ_documentosCurso.ascx" TagName="equ_documentosCurso" TagPrefix="uc2" %>
...
<td class="td_controlesFormulario">
<bus:busquedaAvanzada ID="bus_sucursal" runat="server" 
...
a_bln_mostrarNuevoConDrop="true" a_bln_obligatorio="False" 
...
<td class="td_controlesFormulario">
<asp:TextBox ID="txt_email" runat="server" CssClass="txt_multilinea" 
MaxLength="100"></asp:TextBox>
</td>
...
ControlToValidate="txt_telefono" CssClass="lbl_mensaje" Enabled="false" 
ForeColor="" SetFocusOnError="True" ValidationGroup="form">*</asp:RequiredFieldValidator>
</td>
</tr>
...
a_str_filtros="id_usuario>0 and id_tercero=0" />
</td>
<td>
</td>
</tr>
...
<tr id="Tr3" align='right' runat="server" visible="false">
<td align='right'>
</td>
<td>
<table cellpadding='0' cellspacing='0'>
...
<tr id="Tr4" align='right' runat="server" visible="false">
<td align='right'>
</td>
<td>
<table cellpadding='0' cellspacing='0'>
...
<asp:Button ID="bus_moneda_valor"  Runat="server" style="display: none;"  ValidationGroup="false"/>
</tr>
