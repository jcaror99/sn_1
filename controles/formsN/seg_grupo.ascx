<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='seg_grupo.ascx.vb' Inherits='website.samm_componentes.controles_seg_seg_grupo_N' %>
...
<asp:Label ID='lbl_grupo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_grupo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_grupo' runat='server' ControlToValidate='txt_grupo'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_grupo_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_grupo_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
