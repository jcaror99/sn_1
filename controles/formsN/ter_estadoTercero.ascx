<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='ter_estadoTercero.ascx.vb'
Inherits='website.samm_componentes.controles_seg_ter_estadoTercero_N' %>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_estadoTercero' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_estadoTercero' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
    <asp:RequiredFieldValidator ID='rfv_estadoTercero' runat='server' ControlToValidate='txt_estadoTercero'
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_estadoTercero_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_estadoTercero_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
