...
Inherits='website.samm_componentes.controles_seg_cat_reemplazo_N' %>
...
<asp:Label ID='lbl_id_catalogo_repuesto' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_catalogo_repuesto_1' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
