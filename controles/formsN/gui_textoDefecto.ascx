<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='gui_textoDefecto.ascx.vb'
Inherits='website.samm_componentes.controles_seg_gui_textoDefecto_N' %>
...
<asp:Label ID='lbl_textoDefecto' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_textoDefecto' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_textoDefecto' runat='server' ControlToValidate='txt_textoDefecto'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_textoDefecto_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_textoDefecto_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_campoTexto' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_campoTexto' runat='server' a_str_tabla='gui_campoTexto'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_Texto' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_Texto' runat='server' a_bln_obligatorio='True' a_str_grupoValidacion='form'>
</txt:textoAvanzado>
</td>
<td>
</td>
