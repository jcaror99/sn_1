<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='equ_opcionAtributo.ascx.vb'
Inherits='website.samm_componentes.controles_seg_equ_opcionAtributo_N' %>
...
<asp:Label ID='lbl_opcionAtributo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_opcionAtributo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_opcionAtributo' runat='server' ControlToValidate='txt_opcionAtributo'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_opcionAtributo_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_opcionAtributo_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_atributo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
