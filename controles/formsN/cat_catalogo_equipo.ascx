<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cat_catalogo_equipo.ascx.vb'
Inherits='website.samm_componentes.controles_seg_cat_catalogo_equipo_N' %>
...
<asp:Label ID='lbl_catalogo_equipo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_catalogo_equipo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_catalogo_equipo' runat='server' ControlToValidate='txt_catalogo_equipo'
...
<bus:busquedaAvanzada ID='bus_subTipoCatalogo' runat='server' a_str_tabla='cat_subtipoCatalogo'
    a_bln_obligatorio='True' a_str_grupoValidacion='form' a_str_filtros="id_tipocatalogo=1" />
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_manejaHorometro' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_manejaHorometro' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
    RepeatLayout='Flow'>
