<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cat_marca.ascx.vb' Inherits='website.samm_componentes.controles_seg_cat_marca_N' %>
...
<asp:Label ID='lbl_marca' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_marca' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_marca' runat='server' ControlToValidate='txt_marca'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_marca_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_tercero_fabricante' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_tercero_fabricante' runat='server' a_str_tabla='ter_tercero'
