<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='dis_estadoEvento.ascx.vb' Inherits='website.samm_componentes.controles_seg_dis_estadoEvento_N' %>
...
<td align='right'></td>        <td class='td_lblFormulario'>
            <asp:Label ID='lbl_estadoEvento' runat='server' cssclass='lblobligatorio'></asp:Label></td>
        <td class='td_controlesFormulario'>
           <asp:TextBox ID='txt_estadoEvento' runat='server'  MaxLength='300' CssClass='txt_multilinea'></asp:TextBox>
</td>        <td>
<asp:RequiredFieldValidator ID='rfv_estadoEvento' runat='server' ControlToValidate='txt_estadoEvento' ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="" >*</asp:RequiredFieldValidator>
</td>     </tr>
     <tr>
<td align='right'></td>        <td class='td_lblFormulario'>
            <asp:Label ID='lbl_estadoEvento_codigo' runat='server' cssclass='lbl'></asp:Label></td>
        <td class='td_controlesFormulario'>
           <asp:TextBox ID='txt_estadoEvento_codigo' runat='server'  MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>        <td>
</td>     </tr>
</table>
