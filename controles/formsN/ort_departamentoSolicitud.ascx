<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='ort_departamentoSolicitud.ascx.vb'
Inherits='website.samm_componentes.controles_seg_ort_departamentoSolicitud_N' %>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_departamentoSolicitud' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_departamentoSolicitud' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
    <asp:RequiredFieldValidator ID='rfv_departamentoSolicitud' runat='server' ControlToValidate='txt_departamentoSolicitud'
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_departamentoSolicitud_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_departamentoSolicitud_codigo' runat='server' MaxLength='100'
        CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_recibeSolicitudes' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:RadioButtonList ID='rbl_recibeSolicitudes' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
        RepeatLayout='Flow'>
...
<td>
    <asp:RequiredFieldValidator ID='rfv_recibeSolicitudes' runat='server' ControlToValidate='rbl_recibeSolicitudes'
        ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
</table>
