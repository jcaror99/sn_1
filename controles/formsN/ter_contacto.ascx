...
Inherits='website.samm_componentes.controles_seg_ter_contacto_N' %>
...
<td>
<%--<asp:RequiredFieldValidator ID='rfv_contacto_codigo' runat='server' ControlToValidate='txt_contacto_codigo'ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>--%>
</td>
</tr>
<tr>
<td align ="right" ></td>
