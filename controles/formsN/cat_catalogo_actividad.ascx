...
Inherits='website.samm_componentes.controles_seg_cat_catalogo_actividad_N' %>
...
<tr>
    <td align='right'>
        <asp:Label ID='lbl_tiempoConsecucion'  Visible="false"  runat='server' CssClass='lbl'></asp:Label>
    </td>
    <td align='right' style='padding-left: 8px'>
...
<tr>
    <td>
        <asp:TextBox ID='txt_tiempoConsecucion' Visible="false" runat='server' CssClass='txt_entero'></asp:TextBox>
    </td>
</tr>
<tr>
    <td>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_esNacional' Visible="false"  runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_esNacional'  Visible="false" runat='server' CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
...
<td>
<asp:RequiredFieldValidator ID='rfv_esNacional' Visible="false"  runat='server' ControlToValidate='rbl_esNacional'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
