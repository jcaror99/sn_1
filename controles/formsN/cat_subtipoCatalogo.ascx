<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cat_subtipoCatalogo.ascx.vb'
Inherits='website.samm_componentes.controles_seg_cat_subtipoCatalogo_N' %>
...
<asp:Label ID='lbl_subtipoCatalogo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_subtipoCatalogo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_subtipoCatalogo' runat='server' ControlToValidate='txt_subtipoCatalogo'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_subtipoCatalogo_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_subtipoCatalogo_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_tipoCatalogo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_tipoCatalogo' runat='server' a_str_tabla='cat_tipoCatalogo'
