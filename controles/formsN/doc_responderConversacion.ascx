<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_responderConversacion.ascx.vb'
 Inherits='website.samm_componentes.controles_formsN_doc_responderConversacion_N' %>
...
targetcontrolid='chb_ayudaCampo' 
...
<asp:Label ID='lbl_documentoComentario' runat='server' CssClass="lbl"></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_documentoComentario' runat='server'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_documentoComentario_responder' runat='server' CssClass="lbl"></asp:Label>
</td>
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_documentoComentario_responder' runat='server' CssClass='txt_multilinea' ></txt:textoAvanzado>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_documentoComentario_respuesta' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<txt:textoAvanzado  ID='txt_documentoComentario_respuesta' runat='server' a_bln_obligatorio='True'  CssClass='txt_multilinea'></txt:textoAvanzado >
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_comentario_respuesta' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_comentarioRespuesta' runat='server'  a_bln_obligatorio='true' a_bol_txtnormal ="true"    >
</txt:textoAvanzado>
</td>
<td>
</td>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_documento' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
...
<asp:Label ID='lbl_pendienteRes' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_pendienteRes' runat='server'  CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
...
<td><%-- <uc3:busquedaAvanzadaMultiple ID="bus_usuario" runat="server" 
    ...
    <div id="div_tecnicos" runat="server" class="container">
        ...
        <div>
            <asp:GridView ID="grd_tecnicos" runat="server" AutoGenerateColumns="false" RowStyle-CssClass="txtSamm"
                ShowHeader="false" ShowFooter="false" BorderStyle="None" GridLines="None" Enabled="true">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
...
<tr id="tr_relevante" runat ="server">
<td></td>
<td class="td_lblFormulario" >
</td>
<td colspan="2"  >
...
<td colspan="2"  >
<asp:CheckBox ID='chb_finalizar' runat='server' CssClass='lbl' Visible ="false" />
