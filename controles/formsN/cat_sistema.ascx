<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cat_sistema.ascx.vb'
Inherits='website.samm_componentes.controles_seg_cat_sistema_N' %>
...
<asp:TextBox ID='txt_sistema' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_sistema' runat='server' ControlToValidate='txt_sistema'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_sistema_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_sistema_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
<tr>
        ...
        <td class='td_lblFormulario'>
            <asp:Label ID='lbl_idSistema' runat='server' CssClass='lbl'></asp:Label>
        </td>
        <td class='td_controlesFormulario'>
            <bus:busquedaAvanzada ID='bus_idSistema' runat='server' a_str_tabla='cat_sistema' />
        </td>
        <td>
        </td>
    </tr>
