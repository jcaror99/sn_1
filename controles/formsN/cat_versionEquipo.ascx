<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cat_versionEquipo.ascx.vb'
Inherits='website.samm_componentes.controles_seg_cat_versionEquipo_N' %>
...
<asp:Label ID='lbl_versionEquipo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_versionEquipo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_versionEquipo' runat='server' ControlToValidate='txt_versionEquipo'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_versionEquipo_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_versionEquipo_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<bus:busquedaAvanzada ID='bus_catalogo_equipo' runat='server' a_str_tabla='cat_catalogo.equipo'
    a_bln_obligatorio='True' a_str_grupoValidacion='form' Visible="true" />
</td>
<td>
</td>
</tr>
