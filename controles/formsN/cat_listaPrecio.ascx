...
Inherits='website.samm_componentes.controles_seg_cat_listaPrecio_N' %>
...
id='ftb_porcentajeDescuento' runat='server' targetcontrolid='txt_porcentajeDescuento'
filtertype='Numbers,Custom' /><act:filteredtextboxextender id='ftb_porcentajeDescuento_bus'
runat='server' targetcontrolid='txt_porcentajeDescuento_bus' filtertype='Numbers,Custom' />
</td>
</tr>
</table>
