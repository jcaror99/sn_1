<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cat_tipoCatalogo.ascx.vb'
Inherits='website.samm_componentes.controles_seg_cat_tipoCatalogo_N' %>
...
<asp:Label ID='lbl_tipoCatalogo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_tipoCatalogo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_tipoCatalogo' runat='server' ControlToValidate='txt_tipoCatalogo'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_tipoCatalogo_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_tipoCatalogo_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_afectaInventario' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_afectaInventario' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
...
<td>
<asp:RequiredFieldValidator ID='rfv_afectaInventario' runat='server' ControlToValidate='rbl_afectaInventario'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
<tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_afectaProduccion' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
...
<td>
<asp:RequiredFieldValidator ID='rfv_afectaProduccion' runat='server' ControlToValidate='rbl_afectaProduccion'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
</table>
