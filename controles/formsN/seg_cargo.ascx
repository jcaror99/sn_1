<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='seg_cargo.ascx.vb' Inherits='website.samm_componentes.controles_seg_seg_cargo_N' %>
...
<asp:Label ID='lbl_cargo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
