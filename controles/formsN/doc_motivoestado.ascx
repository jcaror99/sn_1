<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_motivoestado.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_motivoestado_N' %>
...
<asp:Label ID='lbl_motivoestado' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_motivoestado' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_motivoestado' runat='server' ControlToValidate='txt_motivoestado'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_motivoestado_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_motivoestado_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
