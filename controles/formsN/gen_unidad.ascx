<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='gen_unidad.ascx.vb' Inherits='website.samm_componentes.controles_seg_gen_unidad_N' %>
...
<asp:Label ID='lbl_unidad' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_unidad' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_unidad' runat='server' ControlToValidate='txt_unidad'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_unidad_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_unidad_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
