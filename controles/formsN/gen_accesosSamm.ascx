<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='gen_accesosSamm.ascx.vb'
Inherits='website.samm_componentes.controles_seg_gen_accesosSamm_N' %>
...
<asp:Label ID='lbl_accesosSamm' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_accesosSamm' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_accesosSamm' runat='server' ControlToValidate='txt_accesosSamm'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_accesosSamm_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_direccionIP' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_direccionIP' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_direccionIP' runat='server' ControlToValidate='txt_direccionIP'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
<tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_esHijo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_esHijo' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
...
<td>
<asp:RequiredFieldValidator ID='rfv_esHijo' runat='server' ControlToValidate='rbl_esHijo'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
<tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_edita' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_edita' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
<asp:ListItem Value='1' Text='<%$ Resources:res_etiquetas,si %>'></asp:ListItem>
<asp:ListItem Value='0' Text='<%$ Resources:res_etiquetas,no %>'></asp:ListItem>
</asp:RadioButtonList>
...
<td>
<asp:RequiredFieldValidator ID='rfv_edita' runat='server' ControlToValidate='rbl_edita'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
</table>
