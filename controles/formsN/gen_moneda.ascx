<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='gen_moneda.ascx.vb' Inherits='website.samm_componentes.controles_seg_gen_moneda_N' %>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_moneda' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_moneda' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
    <asp:RequiredFieldValidator ID='rfv_moneda' runat='server' ControlToValidate='txt_moneda'
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_moneda_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_moneda_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_abreviatura' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_abreviatura' runat='server' MaxLength='10' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
    <asp:RequiredFieldValidator ID='rfv_abreviatura' runat='server' ControlToValidate='txt_abreviatura'
        ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
<tr align='right'>
...
<td>
    <table cellpadding='0' cellspacing='0'>
        <tr>
            <td align='right'>
                <asp:Label ID='lbl_cambio' runat='server' CssClass='lblobligatorio'></asp:Label>
            </td>
            <td align='right' style='padding-left: 8px'>
                <asp:Label ID='lbl_cambio_busDesde' runat='server' CssClass='lbl'></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td align='right'>
                <asp:Label ID='lbl_cambio_busA' runat='server' CssClass='lbl'></asp:Label>
            </td>
        </tr>
    </table>
</td>
<td class='td_controlesFormulario'>
    <table cellpadding='0' cellspacing='0'>
        <tr>
            <td>
                <asp:TextBox ID='txt_cambio' runat='server' CssClass='txt_numero'></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
                <asp:TextBox ID='txt_cambio_bus' runat='server' CssClass='txt_numero_bus'></asp:TextBox>
            </td>
        </tr>
    </table>
</td>
<td>
    <asp:RequiredFieldValidator ID='rfv_cambio' runat='server' ControlToValidate='txt_cambio'
        ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator><act:filteredtextboxextender
            id='ftb_cambio' runat='server' targetcontrolid='txt_cambio' filtertype='Numbers,Custom' /><act:filteredtextboxextender
                id='ftb_cambio_bus' runat='server' targetcontrolid='txt_cambio_bus' filtertype='Numbers,Custom' />
</td>
</tr>
</table>
