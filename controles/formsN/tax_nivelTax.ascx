<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='tax_nivelTax.ascx.vb' Inherits='website.samm_componentes.controles_seg_tax_nivelTax_N' %>
...
<tr>
    <td align='right' colspan='1' class='td_formEspacioH'><img alt='' src='../../images/interfaz/spacer.gif' style='width:17px;height:1px' />
    </td>
    <td align='right' colspan='3' class='td_formEspacioV'></td></tr><tr><td align='right'></td>
    <td align='right' valign='top'>
        ...
        </act:ToggleButtonExtender><table border='0' cellpadding='0' cellspacing='0' id='tbl_estadoformulario'><tr><td><asp:Label ID='lbl_estadoFormulario' runat='server' CssClass='lbl_estadoFormulario'></asp:Label></td><td><asp:CheckBox ID='chb_ayudaCampo' runat='server' AutoPostBack='True' CssClass='chb' /></td></tr></table><table>
     <tr>
...
<td align='right'></td>        <td class='td_lblFormulario'>
     ...
     <tr>
<td align='right'></td>        <td class='td_lblFormulario'>
            <asp:Label ID='lbl_id_nivelTax' runat='server' cssclass='lblobligatorio'></asp:Label></td>
        <td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_nivelTax' runat='server' a_str_tabla='tax_nivelTax' a_bln_obligatorio='True' a_str_grupoValidacion='form'  /></td>        <td>
</td>     </tr>
     <tr>
<td align='right'></td>        <td class='td_lblFormulario'>
...
<td align='right'></td>        <td class='td_lblFormulario'>
        ...
        <td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_esEquipo' runat='server' CssClass='rbl' RepeatDirection='Horizontal' RepeatLayout='Flow'><asp:ListItem Value='1' Text='<%$ Resources:res_etiquetas,si %>'></asp:ListItem><asp:ListItem Value='0' Text='<%$ Resources:res_etiquetas,no %>'></asp:ListItem></asp:RadioButtonList>            </td>        <td>
