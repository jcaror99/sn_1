...
Inherits='website.samm_componentes.controles_seg_gen_presupuestoEmpresa_N' %>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_presupuestoEmpresa' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_id_empresa' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
