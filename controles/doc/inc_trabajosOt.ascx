<%@ Control Language="VB" AutoEventWireup="false" CodeBehind="inc_trabajosOt.ascx.vb"
    Inherits="website.samm_componentes.controles_ort_inc_trabajosOt" %>
...
<script type="text/javascript" src="../../js/reporte/mapaReporte.js"></script>
<table>
    <tr>
        <td>
            <bti:BotonImagen ID="btnNuevo" runat="server" CausesValidation="False" CssClass="imb"
                ImageUrl="~/images/botones/agregar.gif"></bti:BotonImagen>
            <bti:BotonImagen ID="btn_editar" runat="server" CausesValidation="false" CssClass="imb"
                ImageUrl="~/images/botones/editar.gif"></bti:BotonImagen>
            ...
            <bti:BotonImagen ID="btn_informe" runat="server" CausesValidation="false" CssClass="imb"
                ImageUrl="~/images/botones/ort_infcliente.gif"></bti:BotonImagen>
            <bti:BotonImagen ID="btn_previsualizar" runat="server" CausesValidation="false" CssClass="imb"
                ImageUrl="~/images/botones/previewReporte.png"></bti:BotonImagen>
            <bti:BotonImagen ID="btn_actualizar" runat="server" CausesValidation="false" CssClass="imb"
                ImageUrl="~/images/botones/actualizar.gif"></bti:BotonImagen>    
        </td>
    </tr>
    <tr>
