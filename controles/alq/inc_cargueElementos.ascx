<%@ Control Language="VB" AutoEventWireup="false" CodeBehind="inc_cargueElementos.ascx.vb"
    Inherits="website.samm_componentes.controles_alq_inc_cargueElementos" %>
                ...
                <tr>
                    <td class="tituloPaginaazulCopy" valign="top" background="../../images/importar/banner_samm_actualiza.jpg">
                        <table height="60" cellspacing="0" cellpadding="0" width="250" border="0">
                            <tr>
                                <td class="tituloPaginaazulCopy" height="76"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="tituloPagina" valign="top" background="../../images/importar/fondo_bthome.jpg">
                                <table height="8" cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tbody>
                                        <tr>
                                            <td class="tituloPaginaazul" width="5%" height="20">1.
                                            </td>
                                            <td class="tituloPagina" height="20">
                                                <asp:Label ID="lbl_seleccionarElemento" runat="server" Text="Seleccione el tipo de elementos que va a cargar"></asp:Label>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <tr>
                            <td class="comun" valign="top" bgcolor="#d2e3f0" height="18">
                                ...
                                <asp:RadioButtonList ID="rbl_serializados" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Selected="True" Value="1" Text="Serializados">
                                    </asp:ListItem>
                                    <asp:ListItem Value="0" Text="No serializados">
                                    </asp:ListItem>
                                ...
                                <br />
                                <asp:Label ID="Label6" runat="server" CssClass="lbl_titulo2"></asp:Label>
                            </td>
                        ...
                        <tr>
                            <td class="tituloPagina" valign="center" background="../../images/importar/fondo_bthome.jpg"
                                ...
                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                    <tbody>
                                        <tr>
                                            <td class="tituloPaginaazul" width="2%">2.
                                            </td>
                    ...
                    <tr>
                        <td class="tituloPagina" valign="top" background="../../images/importar/fondo_bthome.jpg">
                            <table height="8" cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    <tr>
                                        <td class="tituloPaginaazul" width="5%" height="20">3.
                                        </td>
                                        <td class="tituloPagina" height="20">
                    ...
                    <tr>
                        <td class="tituloPagina" valign="top" background="../../images/importar/fondo_bthome.jpg">
                            <table height="8" cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tbody>
                                    <tr>
                                        <td class="tituloPaginaazul" width="5%" height="20">4.
                                        </td>
                                        <td class="tituloPagina" height="20">
...
<span class="tituloPaginaazul">5.</span>
</td>
<td width="98%">
                ...
                <tr>
                    <td class="tituloPagina" valign="top" background="../../images/importar/fondo_bthome.jpg"
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                            <tbody>
                                <tr>
                                    <td class="tituloPaginaazul" width="2%">5.
                                    </td>
