<%@ Control Language="VB" AutoEventWireup="false" CodeBehind="inc_tiemposRespuesta.ascx.vb" Inherits="website.samm_componentes.controles_cnt_inc_tiemposRespuesta" %>
