<%@ Control Language="VB" AutoEventWireup="false" CodeBehind="inc_checkListOT.ascx.vb"
    Inherits="website.samm_componentes.controles_ort_inc_checkListOT" %>
...
<table>
    <tr>
        <td>
            ...
            <asp:CheckBox ID="chb_mostrarSugeridos" runat="server" AutoPostBack="True" CssClass="chb" Visible="false" />
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        <td>
            <cc1:BotonImagen ID="bti_eliminar" runat="server" CausesValidation="False" ImageUrl="~/images/botones/quitar.gif" Visible=false /><cc1:BotonImagen
                ID="btiImprimir" runat="server" CausesValidation="False" ImageUrl="~/images/botones/print.gif"  Visible=false/>
        </td>
    </tr>
    <tr>
        <td>          
            <uc1:fechaAvanzada ID="FechaCopia" runat="server" a_str_prefijo="ff" a_bln_obligatorio="false" Visible=false />
            <asp:CheckBox ID="chb_fechas" runat="server" AutoPostBack="false" CssClass="chb"  Visible=false />
        </td>
    </tr>
</table>
<table>
