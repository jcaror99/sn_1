<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_evaluacion.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_evaluacion' %>
...
<tr>
    ...
    <td class='td_lblFormulario'>
        <asp:Label ID='lbl_evaluacion' runat='server' CssClass='lblobligatorio'></asp:Label>
    </td>
    <td class='td_controlesFormulario'>
        <asp:TextBox ID='txt_evaluacion' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
    </td>
    <td>
        <asp:RequiredFieldValidator ID='rfv_evaluacion' runat='server' ControlToValidate='txt_evaluacion'
...
<tr>
    ...
    <td class='td_lblFormulario'>
        <asp:Label ID='lbl_evaluacion_codigo' runat='server' CssClass='lbl'></asp:Label>
    </td>
    <td class='td_controlesFormulario'>
        <asp:TextBox ID='txt_evaluacion_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
    </td>
    <td>
    </td>
</tr>
...
<tr>
    ...
    <td class='td_controlesFormulario'>
        <bus:busquedaAvanzada ID='bus_subTipodocumento' runat='server' a_str_tabla='doc_subtipoDocumento'
            a_bln_obligatorio='True' a_str_grupoValidacion='form' a_str_campo="subtipodocumento,id_tipodocumento" />
    </td>
    <td>
    </td>
</tr>
