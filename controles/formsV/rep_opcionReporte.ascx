<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='rep_opcionReporte.ascx.vb' Inherits='website.samm_componentes.controles_seg_rep_opcionReporte' %>
...
<asp:Label ID='lbl_opcionReporte' runat='server' cssclass='lblobligatorio'></asp:Label></td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_opcionReporte' runat='server'  MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>        <td>
<asp:RequiredFieldValidator ID='rfv_opcionReporte' runat='server' ControlToValidate='txt_opcionReporte' ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="" >*</asp:RequiredFieldValidator>
</td>     </tr>
<tr>
<td align='right'></td>        <td class='td_lblFormulario'>
<asp:Label ID='lbl_opcionReporte_codigo' runat='server' cssclass='lbl'></asp:Label></td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_opcionReporte_codigo' runat='server'  MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>        <td>
</td>     </tr>
</table>
