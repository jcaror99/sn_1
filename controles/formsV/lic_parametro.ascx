<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='lic_parametro.ascx.vb'
Inherits='website.samm_componentes.controles_seg_lic_parametro' %>
...
<asp:Label ID='lbl_parametro' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_parametro' runat='server' MaxLength='300' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_parametro' runat='server' ControlToValidate='txt_parametro'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_parametro_codigo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_parametro_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
<asp:RequiredFieldValidator ID='RequiredFieldValidator1' runat='server' ControlToValidate='txt_parametro_codigo'
    ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
...
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_descripcion' runat='server' a_bln_obligatorio='true' a_str_grupoValidacion='form'>
</txt:textoAvanzado>
</td>
<td>
</td>
