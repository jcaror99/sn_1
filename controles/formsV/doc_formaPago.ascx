<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_formaPago.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_formaPago' %>
...
<asp:TextBox ID='txt_formaPago' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_formaPago' runat='server' ControlToValidate='txt_formaPago'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_formaPago_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_formaPago_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_diasPago' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_diasPago' runat='server' MaxLength='100' CssClass='txt_formulario'></asp:TextBox>
</td>
<td>
</td>
</tr>
