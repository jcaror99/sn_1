<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='gen_familia.ascx.vb'
Inherits='website.samm_componentes.controles_seg_gen_familia' %>
...
<asp:Label ID='lbl_familia' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_familia' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_familia' runat='server' ControlToValidate='txt_familia'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_familia_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:Label ID="lbl_familia_codigo_auto" runat="server" CssClass="lbl"></asp:Label><asp:TextBox
ID='txt_familia_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID="rfv_familia_codigo" runat="server" ControlToValidate="txt_familia_codigo"
...
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_familia' runat='server' a_str_tabla='gen_familia' a_bol_postBack="true" />
</td>
<td>
</td>
</tr>
