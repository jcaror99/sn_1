<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='equ_prestamo.ascx.vb'
Inherits='website.samm_componentes.controles_seg_equ_prestamo' %>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_prestamo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_prestamo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
    <asp:RequiredFieldValidator ID='rfv_prestamo' runat='server' ControlToValidate='txt_prestamo'
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_prestamo_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_prestamo_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_id_usuario_entrego' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <bus:busquedaAvanzada ID='bus_usuario_entrego' runat='server' a_str_tabla='seg_usuario'
...
<td>
    <table cellpadding='0' cellspacing='0'>
        <tr>
            <td align='right'>
                <asp:Label ID='lbl_fechaPrestamo_ff' runat='server' CssClass='lblobligatorio'></asp:Label>
            </td>
            <td align='right' style='padding-left: 8px'>
                <asp:Label ID='lbl_fechaPrestamo_ff_busDesde' runat='server' CssClass='lblobligatorio'></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td align='right'>
                <asp:Label ID='lbl_fechaPrestamo_ff_busA' runat='server' CssClass='lblobligatorio'></asp:Label>
            </td>
        </tr>
    </table>
</td>
<td class='td_controlesFormulario'>
    <table cellpadding='0' cellspacing='0'>
        <tr>
            <td>
                <fec:fechaAvanzada ID='fec_fechaPrestamo_ff' runat='server' a_str_prefijo='fh' a_bln_obligatorio='false'>
                </fec:fechaAvanzada>
            </td>
        </tr>
        <tr>
            <td>
                <fec:fechaAvanzada ID='fec_fechaPrestamo_ff_bus' runat='server' CssClass='txt_fecha_bus'
...
<td class='td_controlesFormulario'>
    <table cellpadding='0' cellspacing='0'>
        <tr>
            <td>
                <fec:fechaAvanzada ID='fec_fechaCompromiso_ff' runat='server' a_str_prefijo='fh'
...
<td class='td_controlesFormulario'>
    <txt:textoAvanzado ID='txt_notas' runat='server' MaxLength='300'></txt:textoAvanzado>
</td>
<td>
</td>
</tr>
...
<td class="td_controlesFormulario">
    <bus:busquedaAvanzada ID="bus_estados" runat="server" a_str_tabla="equ_estadoPrestamo" />
</td>
<td>
</td>
</tr>
...
<td align="center" valign="bottom">
    <asp:Label ID="lbl_mensaje" runat="server" CssClass="lbl_mensaje"></asp:Label><asp:ValidationSummary
        ID='ValidationSummary1' runat='server' ValidationGroup='form' CssClass='lbl_mensaje'
        ForeColor='' />
</td>
