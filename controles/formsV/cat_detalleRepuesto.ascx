<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cat_detalleRepuesto.ascx.vb'
Inherits='website.samm_componentes.controles_seg_cat_detalleRepuesto' %>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_detalleRepuesto' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_detalleRepuesto' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
    <asp:RequiredFieldValidator ID='rfv_detalleRepuesto' runat='server' ControlToValidate='txt_detalleRepuesto'
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_detalleRepuesto_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <asp:TextBox ID='txt_detalleRepuesto_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
    <asp:Label ID='lbl_id_catalogo_repuesto_hijo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
    <bus:busquedaAvanzada ID='bus_catalogo_repuesto_hijo' runat='server' a_str_tabla='cat_catalogo.repuesto'
        a_bln_obligatorio='True' a_str_grupoValidacion='form' />
</td>
<td>
</td>
    ...
    <table cellpadding='0' cellspacing='0'>
        <tr>
            ...
            <td align='right' style='padding-left: 8px'>
                <asp:Label ID='lbl_cantidad_busDesde' runat='server' CssClass='lbl'></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td align='right'>
                <asp:Label ID='lbl_cantidad_busA' runat='server' CssClass='lbl'></asp:Label>
            </td>
        </tr>
    </table>
</td>
...
<td>
    <asp:RequiredFieldValidator ID='rfv_cantidad' runat='server' ControlToValidate='txt_cantidad'
        ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator><act:filteredtextboxextender
            ...
            validchars='' /><act:filteredtextboxextender id='ftb_cantidad_bus' runat='server'
                targetcontrolid='txt_cantidad_bus' filtertype='Numbers,Custom' />
</td>
</tr>
</table>
