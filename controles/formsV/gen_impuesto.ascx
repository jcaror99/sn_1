<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='gen_impuesto.ascx.vb'
Inherits='website.samm_componentes.controles_seg_gen_impuesto' %>
...
<asp:Label ID='lbl_impuesto' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_impuesto' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_impuesto' runat='server' ControlToValidate='txt_impuesto'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_impuesto_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
...
<td>
<asp:RangeValidator ID="rgvImpuesto" runat="server" ControlToValidate="txt_valor"
CssClass="lbl_mensaje" MaximumValue="100" MinimumValue="0" SetFocusOnError="True"
Type="Double" ValidationGroup="form"></asp:RangeValidator><act:filteredtextboxextender
