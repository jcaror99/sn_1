<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_opcionCondicion.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_opcionCondicion' %>
...
<asp:Label ID='lbl_opcionCondicion' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_opcionCondicion' runat='server' MaxLength='300' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_opcionCondicion' runat='server' ControlToValidate='txt_opcionCondicion'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_opcionCondicion_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_opcionCondicion_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
