<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_documento_entrada.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_documento_entrada' %>
...
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_direccionEntrega' runat='server' a_bln_obligatorio='false' a_bol_txtnormal ="true" a_str_grupoValidacion='form'>
</txt:textoAvanzado>
</td>
<td>
</td>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_documento_entrada' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_documento_entrada' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_documento_entrada' runat='server' ControlToValidate='txt_documento_entrada'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
</table>
...
a_bln_obligatorio='False' a_str_grupoValidacion='form' a_str_filtros="esProveedor=1" />
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_esPorAjuste' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_esPorAjuste' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
...
<td>
<asp:RequiredFieldValidator ID='rfv_esPorAjuste' runat='server' ControlToValidate='rbl_esPorAjuste'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
</table>
