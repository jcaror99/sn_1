...
Inherits='website.samm_componentes.controles_seg_ter_tercero' %>
...
<tr>
<td align='right' colspan='1' class='td_formEspacioH' style="width: 1px">
</td>
...
<asp:RadioButtonList ID='rbl_esProspecto' runat='server' CssClass='rbl' RepeatDirection='Horizontal' OnSelectedIndexChanged="rbl_esProspecto_SelectedIndexChanged"
RepeatLayout='Flow'>
...
<td>
<asp:RequiredFieldValidator ID='rfv_esProspecto' runat='server' ControlToValidate='rbl_esProspecto' OnSelectedIndexChanged="rbl_esProspecto_SelectedIndexChanged"
...
ID="rev_nit" runat="server" ControlToValidate="txt_tercero_nit" ValidationGroup="form"
CssClass="lbl_mensaje" ErrorMessage="*" ForeColor="">*</asp:RegularExpressionValidator>
</td>
</tr>
<tr>
<td align='right'>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_formaPago' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_fechaEntrega' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_fechaEntrega' runat='server' CssClass="txt_entero"></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator Enabled="false" ID='rfv_subtotal' runat='server' ControlToValidate='txt_fechaEntrega'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator><act:filteredtextboxextender
    id='ftb_subtotal' runat='server' targetcontrolid='txt_fechaEntrega' filtertype='Numbers' />
...
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_esCliente' runat='server' CssClass='rbl' RepeatDirection='Horizontal' 
RepeatLayout='Flow'>
<asp:ListItem Value='1' Text='<%$ Resources:res_etiquetas,si %>'></asp:ListItem>
<asp:ListItem Value='0' Text='<%$ Resources:res_etiquetas,no %>'></asp:ListItem>
</asp:RadioButtonList>
...
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_esProveedor' runat='server' CssClass='rblobligatorio' 
...
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_esFabricante' runat='server' CssClass='rbl' RepeatDirection='Horizontal' RepeatLayout='Flow'>
<asp:ListItem Value='1' Text='<%$ Resources:res_etiquetas,si %>'></asp:ListItem>
<asp:ListItem Value='0' Text='<%$ Resources:res_etiquetas,no %>'></asp:ListItem>
</asp:RadioButtonList>
</td>
