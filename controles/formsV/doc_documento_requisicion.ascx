<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_documento_requisicion.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_documento_requisicion' %>
...
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator><act:filteredtextboxextender
    id='ftb_iva' runat='server' targetcontrolid='txt_iva' filtertype='Numbers,Custom' />
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_documento_requisicion' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_documento_requisicion' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_documento_requisicion' runat='server' ControlToValidate='txt_documento_requisicion'
...
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_direccionEntrega' runat='server' a_bln_obligatorio='false' a_str_grupoValidacion='form' >
</txt:textoAvanzado>
...
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_observaciones' runat='server'  a_bln_obligatorio='false' a_str_grupoValidacion='form'>
</txt:textoAvanzado>
</td>
<td>
</td>
