<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cat_catalogo_producto.ascx.vb'
Inherits='website.samm_componentes.controles_seg_cat_catalogo_producto' %>
...
<asp:Label ID='lbl_catalogo_producto' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_catalogo_producto' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_catalogo_producto' runat='server' ControlToValidate='txt_catalogo_producto'
...
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_descripcion' runat='server' a_bln_obligatorio='False' a_str_grupoValidacion='form'>
</txt:textoAvanzado>
</td>
<td>
</td>
