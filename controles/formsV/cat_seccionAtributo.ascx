<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cat_seccionAtributo.ascx.vb'
Inherits='website.samm_componentes.controles_seg_cat_seccionAtributo' %>
...
<asp:Label ID='lbl_seccionAtributo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_seccionAtributo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_seccionAtributo' runat='server' ControlToValidate='txt_seccionAtributo'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_seccionAtributo_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_seccionAtributo_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<table cellpadding='0' cellspacing='0'>
    <tr>
        <td align='right'>
            <asp:Label ID='lbl_idusoSeccionAtributo' runat='server' CssClass='lblobligatorio'></asp:Label>
        </td>
    </tr>
</table>
</td>
...
<table cellpadding='0' cellspacing='0'>
    <tr>
        <td>
            <bus:busquedaAvanzada ID='bus_idUsoSeccionAtributo' runat='server' a_str_tabla='cat_usoSeccionAtributo'
