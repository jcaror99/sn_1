...
Inherits='website.samm_componentes.controles_seg_doc_documentoComentario' %>
...
<tr>
    ...
    <td class='td_controlesFormulario'>
        <txt:textoAvanzado ID='txt_comentario' runat='server' a_bln_obligatorio='True' a_str_grupoValidacion='form'>
        </txt:textoAvanzado>
    </td>
    <td>
    </td>
...
<tr>
    ...
    <td>
        <asp:RequiredFieldValidator ID='rfv_recordar' runat='server' ControlToValidate='rbl_recordar'
            ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
    </td>
</tr>
<tr>
