<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='equ_equipo.ascx.vb' Inherits='website.samm_componentes.controles_seg_equ_equipo' %>
...
a_bln_obligatorio='True' a_str_grupoValidacion='form' a_bln_mostrarNuevoConDrop="True" />
</td>
<td>
</td>
</tr>
<tr runat="server" id="tr_sistema" visible="false">
<td align='right'>
</td>
<td class='td_lblFormulario'>
...
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_equipo' runat='server' a_str_tabla='equ_equipo' a_bln_obligatorio='False' a_bol_recursivoTodoelArbol="false" 
a_bol_postBack="True" />
</td>
<td>
</td>
...
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_tercero_servicio' runat='server' a_str_tabla='ter_tercero' a_str_filtros="esProveedor = 1"  a_str_pagina = "equ_equipo" />
</td>
<td>
</td>
</tr>
...
<tr>
<td align='right'>
<asp:Label ID='lbl_fechaPuestaMarcha_fh' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
...
<tr>
<td>
<fec:fechaAvanzada ID='fec_fechaPuestaMarcha_fh' runat='server' a_str_prefijo='fh' a_bln_obligatorio='true'
...
<tr>
<td align='right'>
<asp:Label ID='lbl_ultimaLectura_fh' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td align='right' style='padding-left: 8px'>
