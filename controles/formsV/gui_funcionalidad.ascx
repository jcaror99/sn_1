...
Inherits='website.samm_componentes.controles_seg_gui_funcionalidad' %>
...
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rdl_esmvc' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
<asp:ListItem Value='1' Text='<%$ Resources:res_etiquetas,si %>'></asp:ListItem>
<asp:ListItem Value='0' Text='<%$ Resources:res_etiquetas,no %>'></asp:ListItem>
</asp:RadioButtonList>
...
<td>
<asp:RequiredFieldValidator ID='rfv_esmevc' runat='server' ControlToValidate='rdl_esmvc'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
</table>
