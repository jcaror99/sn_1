<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='seg_sesion.ascx.vb' Inherits='website.samm_componentes.controles_seg_seg_sesion' %>
...
<asp:Label ID='lbl_sesion' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_sesion' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_sesion' runat='server' ControlToValidate='txt_sesion'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_sesion_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_sesion_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_sesion_codigo' runat='server' ControlToValidate='txt_sesion_codigo'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
</table>
