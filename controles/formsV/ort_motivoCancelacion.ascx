<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='ort_motivoCancelacion.ascx.vb'
Inherits='website.samm_componentes.controles_seg_ort_motivoCancelacion' %>
...
<asp:Label ID='lbl_motivoCancelacion' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_motivoCancelacion' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_motivoCancelacion' runat='server' ControlToValidate='txt_motivoCancelacion'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_motivoCancelacion_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_motivoCancelacion_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_responsableServicio' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
