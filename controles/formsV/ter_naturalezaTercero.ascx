<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='ter_naturalezaTercero.ascx.vb'
Inherits='website.samm_componentes.controles_seg_ter_naturalezaTercero' %>
...
<asp:Label ID='lbl_naturalezaTercero' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_naturalezaTercero' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_naturalezaTercero' runat='server' ControlToValidate='txt_naturalezaTercero'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_naturalezaTercero_codigo' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_naturalezaTercero_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_naturalezaTercero_codigo' runat='server' ControlToValidate='txt_naturalezaTercero_codigo'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
</table>
