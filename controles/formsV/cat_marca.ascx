<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cat_marca.ascx.vb' Inherits='website.samm_componentes.controles_seg_cat_marca' %>
...
<asp:Label ID='lbl_marca' runat='server' CssClass='lbl'></asp:Label></td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_marca' runat='server'  MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>        <td>
<asp:RequiredFieldValidator ID='rfv_marca' runat='server' ControlToValidate='txt_marca' ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="" >*</asp:RequiredFieldValidator>
</td>     </tr>
<tr>
<td align='right'></td>        <td class='td_lblFormulario'>
<asp:Label ID='lbl_marca_codigo' runat='server' CssClass='lbl'></asp:Label></td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_marca_codigo' runat='server'  MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>        <td>
</td>     </tr>
<tr>
<td align='right'></td>        <td class='td_lblFormulario'>
<asp:Label ID='lbl_id_tercero_fabricante' runat='server' CssClass='lbl'></asp:Label></td>
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_tercero_fabricante' runat='server' a_str_tabla='ter_tercero' a_bln_obligatorio='false' /></td>        <td>
</td>     </tr>
</table>
