<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_condicion.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_condicion' %>
...
<asp:Label ID='lbl_condicion' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_condicion' runat='server' MaxLength='300' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_condicion' runat='server' ControlToValidate='txt_condicion'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_condicion_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_condicion_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_textoLibre' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_textoLibre' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
...
<td>
<asp:RequiredFieldValidator ID='rfv_textoLibre' runat='server' ControlToValidate='rbl_textoLibre'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
</table>
