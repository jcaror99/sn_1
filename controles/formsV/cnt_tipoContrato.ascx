<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='cnt_tipoContrato.ascx.vb' Inherits='website.samm_componentes.controles_seg_cnt_tipoContrato' %>
...
<asp:Label ID='lbl_tipoContrato' runat='server' cssclass='lblobligatorio'></asp:Label></td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_tipoContrato' runat='server'  MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>        <td>
<asp:RequiredFieldValidator ID='rfv_tipoContrato' runat='server' ControlToValidate='txt_tipoContrato' ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="" >*</asp:RequiredFieldValidator>
</td>     </tr>
<tr>
<td align='right'></td>        <td class='td_lblFormulario'>
<asp:Label ID='lbl_tipoContrato_codigo' runat='server' cssclass='lbl'></asp:Label></td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_tipoContrato_codigo' runat='server'  MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>        <td>
</td>     </tr>
</table>
