<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_documento_salida.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_documento_salida' %>
...
<tr>
<td>
<fec:fechaAvanzada ID='fec_fechaCierre_ff' runat='server' a_str_prefijo='fh' a_bln_obligatorio='false'>
</fec:fechaAvanzada>
</td>
</tr>
<tr>
<td>
<fec:fechaAvanzada ID='fec_fechaCierre_ff_bus' runat='server' a_str_prefijo='fh'
CssClass="txt_fecha_bus" CssClassHora="txt_hora_bus"></fec:fechaAvanzada>
</td>
</tr>
</table>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_documento_salida' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_documento_salida' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_documento_salida' runat='server' ControlToValidate='txt_documento_salida'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_asunto' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_asunto' runat='server' MaxLength='300' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_asunto' runat='server' ControlToValidate='txt_asunto'
...
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_observaciones' runat='server' a_bln_obligatorio='false'>
</txt:textoAvanzado>
</td>
<td>
</td>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_usuario_recibe' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_usuario_recibe' runat='server' a_str_tabla='seg_usuario'
a_bln_obligatorio='True' a_str_grupoValidacion='form' />
</td>
<td>
</td>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_tercero_transportador' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_tercero_transportador' runat='server' a_str_tabla='ter_tercero'
...
ForeColor="">*</asp:RequiredFieldValidator><act:filteredtextboxextender id='ftb_subtotal'
runat='server' targetcontrolid='txt_subtotal' filtertype='Numbers,Custom' /><act:filteredtextboxextender
...
Enabled='false' ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje"
ForeColor="">*</asp:RequiredFieldValidator><act:filteredtextboxextender id='ftb_descuento'
runat='server' targetcontrolid='txt_descuento' filtertype='Numbers,Custom' /><act:filteredtextboxextender
...
Enabled='false' ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje"
ForeColor="">*</asp:RequiredFieldValidator><act:filteredtextboxextender id='ftb_iva'
runat='server' targetcontrolid='txt_iva' filtertype='Numbers,Custom' /><act:filteredtextboxextender
...
Enabled='false' ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje"
ForeColor="">*</asp:RequiredFieldValidator><act:filteredtextboxextender id='ftb_total'
runat='server' targetcontrolid='txt_total' filtertype='Numbers,Custom' /><act:filteredtextboxextender
...
Enabled='false' ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje"
ForeColor="">*</asp:RequiredFieldValidator><act:filteredtextboxextender id='ftb_costo'
