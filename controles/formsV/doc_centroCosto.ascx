<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_centroCosto.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_centroCosto' %>
...
<asp:Label ID='lbl_centroCosto' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_centroCosto' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_centroCosto' runat='server' ControlToValidate='txt_centroCosto'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_centroCosto_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_centroCosto_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
