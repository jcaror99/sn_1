<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='equ_campana.ascx.vb'
Inherits='website.samm_componentes.controles_seg_equ_campana' %>
...
<asp:Label ID='lbl_campana' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_campana' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_campana' runat='server' ControlToValidate='txt_campana'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_campana_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_campana_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_catalogo_tempario' runat='server' CssClass='lbl' Visible="False"></asp:Label>
</td>
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_catalogo_tempario' runat='server' a_str_tabla='cat_catalogo.tempario'
    a_bln_obligatorio='True' a_str_grupoValidacion='form' Visible="false" />
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_detalleCampana' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_detalleCampana' runat='server' a_bln_obligatorio='True'
