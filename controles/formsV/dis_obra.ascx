<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='dis_obra.ascx.vb' Inherits='website.samm_componentes.controles_seg_dis_obra' %>
...
<asp:Label ID='lbl_obra' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_obra' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_obra' runat='server' ControlToValidate='txt_obra'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_obra_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_obra_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<tr>
<td align='right'>
<asp:Label ID='lbl_fechaInicial_ff' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td align='right' style='padding-left: 8px'>
<asp:Label ID='lbl_fechaInicial_ff_busDesde' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
</tr>
<tr>
<td>
...
<td align='right'>
<asp:Label ID='lbl_fechaInicial_ff_busA' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
</tr>
</table>
</td>
...
<tr>
<td>
<fec:fechaAvanzada ID='fec_fechaInicial_ff' runat='server' a_str_prefijo='ff' a_bln_obligatorio='True'
    a_str_grupoValidacion='form'></fec:fechaAvanzada>
</td>
</tr>
<tr>
<td>
<fec:fechaAvanzada ID='fec_fechaInicial_ff_bus' runat='server' CssClass='txt_fecha_bus'
...
<tr>
<td align='right'>
<asp:Label ID='lbl_fechaFinal_ff' runat='server' CssClass='lbl'></asp:Label>
</td>
<td align='right' style='padding-left: 8px'>
<asp:Label ID='lbl_fechaFinal_ff_busDesde' runat='server' CssClass='lbl'></asp:Label>
</td>
</tr>
<tr>
<td>
...
<td align='right'>
<asp:Label ID='lbl_fechaFinal_ff_busA' runat='server' CssClass='lbl'></asp:Label>
</td>
</tr>
</table>
</td>
...
<tr>
<td>
<fec:fechaAvanzada ID='fec_fechaFinal_ff' runat='server' a_str_prefijo='ff' a_bln_obligatorio='false'>
</fec:fechaAvanzada>
</td>
</tr>
<tr>
<td>
<fec:fechaAvanzada ID='fec_fechaFinal_ff_bus' runat='server' CssClass='txt_fecha_bus'
    CssClassHora='txt_hora_bus' a_str_prefijo='ff'></fec:fechaAvanzada>
</td>
</tr>
</table>
...
a_bln_obligatorio='True' a_str_grupoValidacion='form' a_str_filtros="ter_tercero_esEmpresaPropia=1" />
</td>
<td>
</td>
</tr>
