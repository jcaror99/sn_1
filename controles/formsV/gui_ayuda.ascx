<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='gui_ayuda.ascx.vb' Inherits='website.samm_componentes.controles_seg_gui_ayuda' %>
...
<asp:Label ID='lbl_ayuda' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_ayuda' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_ayuda' runat='server' ControlToValidate='txt_ayuda'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_ayuda_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_ayuda_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_ayuda' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_ayuda' runat='server' a_str_tabla='gui_ayuda' a_bln_obligatorio='false'
/>
</td>
<td>
</td>
