...
Inherits='website.samm_componentes.controles_seg_cat_catalogo_repuesto' %>
...
<td   class=' tr_informacion td_controlesFormulario' rowspan='2' style='height: 100%' valign='bottom'>
<table>
<tr align='right'>
<td align='right'>
</td>
...
<table cellpadding='0' cellspacing='0'>
    <tr>
        ...
        <td align='right' style='padding-left: 8px'>
            <asp:Label ID='lbl_peso_busDesde' runat='server' CssClass='lbl'></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td align='right'>
            <asp:Label ID='lbl_peso_busA' runat='server' CssClass='lbl'></asp:Label>
        </td>
    </tr>
</table>
</td>
...
<table cellpadding='0' cellspacing='0'>
    <tr>
        <td>
            <asp:TextBox ID='txt_peso' runat='server' CssClass='txt_precio'></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
            <asp:TextBox ID='txt_peso_bus' runat='server' CssClass='txt_precio_bus'></asp:TextBox>
        </td>
    </tr>
</table>
</td>
<td>
<act:filteredtextboxextender id='ftb_peso' runat='server' targetcontrolid='txt_peso'
    filtertype='Numbers,Custom' />
<act:filteredtextboxextender id='ftb_peso_bus' runat='server' targetcontrolid='txt_peso_bus'
    filtertype='Numbers,Custom' />
</td>
</tr>
