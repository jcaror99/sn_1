<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='gen_bodega.ascx.vb' Inherits='website.samm_componentes.controles_seg_gen_bodega' %>
...
<asp:Label ID='lbl_bodega' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_bodega' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_bodega' runat='server' ControlToValidate='txt_bodega'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_bodega_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
