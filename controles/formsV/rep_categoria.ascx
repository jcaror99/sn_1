<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='rep_categoria.ascx.vb'
Inherits='website.samm_componentes.controles_seg_rep_categoria' %>
...
<asp:Label ID='lbl_categoria' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_categoria' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_categoria' runat='server' ControlToValidate='txt_categoria'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_categoria_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_categoria_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_categoria' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_categoria' runat='server' a_str_tabla='rep_categoria'
