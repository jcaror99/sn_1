<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='dis_motivoEvento.ascx.vb'
Inherits='website.samm_componentes.controles_seg_dis_motivoEvento' %>
...
<asp:Label ID='lbl_motivoEvento' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_motivoEvento' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_motivoEvento' runat='server' ControlToValidate='txt_motivoEvento'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_motivoEvento_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_motivoEvento_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_responsableServicio' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_responsableServicio' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
...
<td>
<asp:RequiredFieldValidator ID='rfv_responsableServicio' runat='server' ControlToValidate='rbl_responsableServicio'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
<tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_VaradaProduccion' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_VaradaProduccion' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
<asp:ListItem Value='1' Text='<%$ Resources:res_etiquetas,si %>'></asp:ListItem>
<asp:ListItem Value='0' Text='<%$ Resources:res_etiquetas,no %>'></asp:ListItem>
</asp:RadioButtonList>
...
<td>
<asp:RequiredFieldValidator ID='rfv_VaradaProduccion' runat='server' ControlToValidate='rbl_VaradaProduccion'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
<tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_esFalla' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:RadioButtonList ID='rbl_esFalla' runat='server' CssClass='rbl' RepeatDirection='Horizontal'
RepeatLayout='Flow'>
<asp:ListItem Value='1' Text='<%$ Resources:res_etiquetas,si %>'></asp:ListItem>
<asp:ListItem Value='0' Text='<%$ Resources:res_etiquetas,no %>'></asp:ListItem>
</asp:RadioButtonList>
...
<td>
<asp:RequiredFieldValidator ID='rfv_esFalla' runat='server' ControlToValidate='rbl_esFalla'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
</table>
