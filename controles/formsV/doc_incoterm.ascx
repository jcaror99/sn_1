<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_incoterm.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_incoterm' %>
...
<asp:Label ID='lbl_incoterm' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_incoterm' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
<asp:RequiredFieldValidator ID='rfv_incoterm' runat='server' ControlToValidate='txt_incoterm'
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_incoterm_codigo' runat='server' CssClass='lbl'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<asp:TextBox ID='txt_incoterm_codigo' runat='server' MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
</td>
</tr>
