<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='doc_documento_ot.ascx.vb'
Inherits='website.samm_componentes.controles_seg_doc_documento_ot' %>
...
BorderWidth="0px" BackColor="transparent" Font-Bold="true" Width="30px"></asp:TextBox><asp:Label
...
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_documento_codigo" ForeColor="">*</asp:RequiredFieldValidator>
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_id_usuario_coordinador' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_usuario_coordinador' a_str_grupoValidacion='form' runat='server' a_str_tabla='seg_usuario'
...
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_equipo' runat='server' a_str_tabla='equ_equipo' a_bln_obligatorio='True' a_str_grupoValidacion='form'
...
<td class='td_controlesFormulario'>
<uc2:equ_documentosCurso ID="eqSols" runat="server" a_bol_mostrarInfoEquipo="true" a_bol_mostrarOT="true" a_bol_mostrarSOL="true" />
...
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_sistema' runat='server' a_str_tabla='cat_sistema' a_bln_obligatorio='False' a_str_grupoValidacion='form' />
</td>
<td>
</td>
</tr>
...
<tr>
<td>
<fec:fechaAvanzada ID='fec_fechaCompromiso_fh' runat='server' a_str_grupoValidacion='form' a_str_prefijo='ff' a_bln_obligatorio='True'>
</fec:fechaAvanzada>
</td>
<td>
...
<tr>
<td align='right'>
<asp:Label ID='lbl_fechaGarantia_ff' runat='server' CssClass='lblobligatorio'></asp:Label>
</td>
<td align='right' style='padding-left: 8px'>
...
<tr>
<td>
<fec:fechaAvanzada ID='fec_fechaGarantia_ff' runat='server' a_str_grupoValidacion='form' a_str_prefijo='ff' a_bln_obligatorio='true'>
</fec:fechaAvanzada>
</td>
</tr>
<tr>
<td>
<fec:fechaAvanzada ID='fec_fechaGarantia_ff_bus' runat='server' CssClass='lblobligatorio'
...
<td class="td_controlesFormulario tr_informacion "  >
<table >
...
<td class="td_lblFormulario">
<asp:Label ID="lbl_usuarioAsignado" runat="server" CssClass="lbl" Text="<%$ Resources:res_metadata,gas_gasto_id_usuario_solicitante %>"></asp:Label>
</td>
<td class="td_controlesFormulario">

<bus:busquedaAvanzada ID='busUsuarioAsignado' runat='server' a_str_tabla='seg_usuario' a_bln_obligatorio='True' a_str_grupoValidacion='form'
...
<td>
<asp:RequiredFieldValidator ID='rvf_cargo' runat='server' ControlToValidate='txt_contacto'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
<td>
</td>
...
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_direccionUbicacion' runat='server' a_bln_obligatorio='true' a_bol_txtnormal ="true" a_str_grupoValidacion='form'>
</txt:textoAvanzado>
</td>
</tr>
...
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_tercero_proveedor' runat='server' a_str_tabla='ter_tercero' a_bln_obligatorio = 'true' a_str_grupoValidacion='form' a_str_pagina = "equ_equipo" />
</td>
<td>
</td>
</tr>
...
<td class='td_lblFormulario'>
<asp:Label ID='lbl_motivoServicio' runat='server'></asp:Label>
</td>
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_motivoServicio' runat='server' a_bln_obligatorio='false' 
a_str_grupoValidacion='form'></txt:textoAvanzado>
</td>
<%--<td>
<asp:RequiredFieldValidator ID='rfv_motivoServicio' runat='server' ControlToValidate='txt_fax'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>--%>
<td>
</td>
...
<td class='td_controlesFormulario'>
<txt:textoAvanzado ID='txt_diagnosticoInicial' runat='server' a_bln_obligatorio='true'>
</txt:textoAvanzado>
</td>
<td>
</td>
...
<td>
<asp:RequiredFieldValidator ID='rfv_duracionEstimada' runat='server' ControlToValidate='txt_duracionEstimada'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
<tr>
...
<td>
<asp:RequiredFieldValidator ID='rfv_reclamacionFabrica' runat='server' ControlToValidate='txt_reclamacionFabrica'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
</tr>
<tr runat="server" visible="false">
...
<td>
<asp:RequiredFieldValidator ID='rfv_id_contrato' runat='server' ControlToValidate='bus_contrato'
ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="">*</asp:RequiredFieldValidator>
</td>
<td>
</td>
...
<br />
<asp:HyperLink ID="hyp_mensaje" Visible="false" runat="server"  Target="_new"></asp:HyperLink>
</td>
