...
Inherits='website.samm_componentes.controles_seg_cat_atributo' %>
...
<asp:TextBox ID='txt_atributo' runat='server' MaxLength='900' CssClass='txt_multilinea'></asp:TextBox>
</td>
<td>
...
<td class='td_controlesFormulario'>
<bus:busquedaAvanzada ID='bus_unidad' runat='server' a_str_tabla='gen_unidad' />
</td>
<td>
</td>
</tr>
