<%@ Control Language='VB' AutoEventWireup='false' CodeBehind='ter_cargoContacto.ascx.vb' Inherits='website.samm_componentes.controles_seg_ter_cargoContacto' %>
...
<td align='right'></td>        <td class='td_lblFormulario'>
            <asp:Label ID='lbl_cargoContacto' runat='server' cssclass='lblobligatorio'></asp:Label></td>
        <td class='td_controlesFormulario'>
           <asp:TextBox ID='txt_cargoContacto' runat='server'  MaxLength='300' CssClass='txt_multilinea'></asp:TextBox>
</td>        <td>
<asp:RequiredFieldValidator ID='rfv_cargoContacto' runat='server' ControlToValidate='txt_cargoContacto' ValidationGroup="form" SetFocusOnError='True' CssClass="lbl_mensaje" ForeColor="" >*</asp:RequiredFieldValidator>
</td>     </tr>
     <tr>
<td align='right'></td>        <td class='td_lblFormulario'>
            <asp:Label ID='lbl_cargoContacto_codigo' runat='server' cssclass='lbl'></asp:Label></td>
        <td class='td_controlesFormulario'>
           <asp:TextBox ID='txt_cargoContacto_codigo' runat='server'  MaxLength='100' CssClass='txt_multilinea'></asp:TextBox>
</td>        <td>
</td>     </tr>
      </table>
