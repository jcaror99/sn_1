<%@ Control Language="VB" AutoEventWireup="false" CodeBehind="pop_agruparRepuesto.ascx.vb" Inherits="website.samm_componentes.controles_cat_pop_agruparRepuesto" %>
...
<table>
    <tr>
        <td align="center">
            <asp:Label ID="lbl_bodega" runat="server" Text='<%$Resources: res_metadata,gen_bodega_bodega %>' CssClass='lbl'></asp:Label></td>
        <td align="center">
    ...
    <tr>
        <td align="center">
            <asp:Label ID="lbl_cantidadConformar" runat="server" Text='<%$Resources: res_etiquetas_cat,cantidadConformar %>' CssClass='lbl'></asp:Label></td>
        <td align="center">
            <asp:TextBox ID="txt_cantidadConformar" runat="server" CssClass='txt_numero'></asp:TextBox><br />
