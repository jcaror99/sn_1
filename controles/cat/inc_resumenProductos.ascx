<%@ Control Language="VB" AutoEventWireup="false" CodeBehind="inc_resumenProductos.ascx.vb" Inherits="website.samm_componentes.controles_cat_inc_resumenProductos" %>
<table>
<tr>
