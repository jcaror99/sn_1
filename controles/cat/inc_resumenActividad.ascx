<%@ Control Language="VB" AutoEventWireup="false" CodeBehind="inc_resumenActividad.ascx.vb" Inherits="website.samm_componentes.controles_cat_inc_resumenActividad" %>
<table>
<tr>
