<%@ Control Language="VB" AutoEventWireup="false" CodeBehind="inc_resumenRepuesto.ascx.vb" Inherits="website.samm_componentes.controles_cat_inc_resumenRepuesto" %>
<table>
<tr>
<asp:Label  ID ="lbl_mensaje" runat="server" Height="20px"></asp:Label>
<td>
<asp:GridView ID="grd" runat="server" AutoGenerateColumns="false" BorderStyle="None" GridLines="None" CellPadding="5" Height="93px" Width="242px">
