<%@ Control Language="VB" AutoEventWireup="false" CodeBehind="inc_resumenModeloEquipo.ascx.vb" Inherits="website.samm_componentes.controles_cat_inc_resumenModeloEquipo" %>
<table>
<tr>
