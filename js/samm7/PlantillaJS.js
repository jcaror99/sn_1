...
document.addEventListener('DOMContentLoaded', function() {
 ...
 document.addEventListener('DOMContentLoaded', function() {
    ...
    ], limit: 4, onAutocomplete: null, minLength: 1, sortFunction: function(a, b, inputString) {
...
function nombreSeccionSucursal(){
  ...
  var nuevoSaludo = document.createElement('H4');
  var contenidoSaludo = document.createTextNode("Nombre Sucursal: "+nombreUsuario);
  nuevoSaludo.appendChild(contenidoSaludo);
  document.getElementsByClassName('container-formularioS')[0].appendChild(nuevoSaludo);
}
function nombreSeccionComponente(){
  ...
  nuevoSaludo.appendChild(contenidoSaludo);
  document.getElementsByClassName('container-formulario')[0].appendChild(nuevoSaludo);
}
...
function crearInputText(){
  ...
  document.getElementsByClassName('preguntas')[0].innerHTML +="<div class='input-field col s10'><input type='text' id='autocomplete-input' class='autocomplete'/><label for='autocomplete-input'>" + nombreDato + "</label></div><div class='s1 m1 l1 push-l1 col'><a class='btn-small btn-floating blue'><i title='Mover' class='material-icons'>more_vert</i></a><a class='btn-small btn-floating blue'><i title='Eliminar' class='material-icons'>delete</i></a></div>";
}
function crearListaSelec(){
  ...
  document.getElementsByClassName('preguntas')[0].innerHTML +="<div class='row'><div class='input-field col s10 l10>'<label>"+ nombreDato +"</label><select class='browser-default'><option value='' disabled selected>Elija una opción</option><option value='1'>"+ nombreOpcion1 +"</option><option value='2'>"+ nombreOpcion2 + "</option></select></div><div class='s1 m1 l1 push-l1 col'><a class='btn-small btn-floating blue'><i title='Mover' class='material-icons'>more_vert</i></a><a class='btn-small btn-floating blue'><i title='Eliminar' class='material-icons'>delete</i></a></div></div>";
...
var Eventos = {
  init: function(){
    ...
    document.querySelector('.boton-checkP i').onclick = this.eventoNombrePlantilla;
